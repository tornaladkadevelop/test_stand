...
def st_test_buz_2():
    ...
    msg_1 = "Убедитесь в отсутствии блоков в панелях разъемов. Вставьте испытуемый блок БУЗ-2 в разъем Х17 на панели B."
    msg_2 = "Вставьте заведомо исправные блок БИ в разъем Х26  и блок БДЗ в разъем Х16, расположенные на панели B."
    if my_msg(msg_1):
        if my_msg(msg_2):
            pass
        else:
