...
def st_test_bki_6_zsh():
    ...
    msg_2 = 'Подключите в разъем, расположенный на панели разъемов А соединительный кабель для проверки блока БКИ-6-3Ш'
    if my_msg(msg_1):
        if my_msg(msg_2):
            pass
        else:
    ...
    sleep(3)
    in_a1, in_a4, in_a5, in_a6, in_a7 = __inputs_a()
